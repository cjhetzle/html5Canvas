...
COREHTML5.RoundedRectangle.prototype = {
   ...
   setSizePercents: function (h, v) {
      // horizontal and vertial size percent
      // represent the size of the rounded 
      // rectangle in terms of horizontal and 
      // vertical percents of the rectangle enclosing dom element
   ...
   fill: function () {
      ...
      this.context.move(this.left + radius, this.top);
